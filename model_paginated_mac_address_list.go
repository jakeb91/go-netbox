...
// checks if the PaginatedMACAddressList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedMACAddressList{}
...
type _PaginatedMACAddressList PaginatedMACAddressList
...
func (o PaginatedMACAddressList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedMACAddressList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedMACAddressList := _PaginatedMACAddressList{}

	err = json.Unmarshal(data, &varPaginatedMACAddressList)

	if err != nil {
		return err
	}

	*o = PaginatedMACAddressList(varPaginatedMACAddressList)
...
type NullablePaginatedMACAddressList struct {
	value *PaginatedMACAddressList
	isSet bool
}

func (v NullablePaginatedMACAddressList) Get() *PaginatedMACAddressList {
	return v.value
}

func (v *NullablePaginatedMACAddressList) Set(val *PaginatedMACAddressList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedMACAddressList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedMACAddressList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedMACAddressList(val *PaginatedMACAddressList) *NullablePaginatedMACAddressList {
	return &NullablePaginatedMACAddressList{value: val, isSet: true}
}

func (v NullablePaginatedMACAddressList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedMACAddressList) UnmarshalJSON(src []byte) error {
	v.isSet = true
