...
// checks if the VirtualCircuitTypeRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualCircuitTypeRequest{}
...
type _VirtualCircuitTypeRequest VirtualCircuitTypeRequest
...
func NewVirtualCircuitTypeRequest(name string, slug string) *VirtualCircuitTypeRequest {
	this := VirtualCircuitTypeRequest{}
	this.Name = name
	this.Slug = slug
	return &this
}
...
func (o VirtualCircuitTypeRequest) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualCircuitTypeRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varVirtualCircuitTypeRequest := _VirtualCircuitTypeRequest{}

	err = json.Unmarshal(data, &varVirtualCircuitTypeRequest)

	if err != nil {
		return err
	}

	*o = VirtualCircuitTypeRequest(varVirtualCircuitTypeRequest)
...
type NullableVirtualCircuitTypeRequest struct {
	value *VirtualCircuitTypeRequest
	isSet bool
}

func (v NullableVirtualCircuitTypeRequest) Get() *VirtualCircuitTypeRequest {
	return v.value
}

func (v *NullableVirtualCircuitTypeRequest) Set(val *VirtualCircuitTypeRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualCircuitTypeRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualCircuitTypeRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualCircuitTypeRequest(val *VirtualCircuitTypeRequest) *NullableVirtualCircuitTypeRequest {
	return &NullableVirtualCircuitTypeRequest{value: val, isSet: true}
}

func (v NullableVirtualCircuitTypeRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualCircuitTypeRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
