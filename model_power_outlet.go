...
func NewPowerOutlet(id int32, url string, display string, device BriefDevice, name string, linkPeers []interface{}, connectedEndpointsReachable bool, occupied bool) *PowerOutlet {
	this := PowerOutlet{}
	this.Id = id
	this.Url = url
...
func (o *PowerOutlet) HasCableEnd() bool {
	if o != nil && !IsNil(o.CableEnd) {
		return true
	}
