...
// checks if the VirtualCircuitTerminationRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualCircuitTerminationRequest{}
...
type _VirtualCircuitTerminationRequest VirtualCircuitTerminationRequest
...
func (o VirtualCircuitTerminationRequest) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualCircuitTerminationRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varVirtualCircuitTerminationRequest := _VirtualCircuitTerminationRequest{}

	err = json.Unmarshal(data, &varVirtualCircuitTerminationRequest)

	if err != nil {
		return err
	}

	*o = VirtualCircuitTerminationRequest(varVirtualCircuitTerminationRequest)
...
type NullableVirtualCircuitTerminationRequest struct {
	value *VirtualCircuitTerminationRequest
	isSet bool
}

func (v NullableVirtualCircuitTerminationRequest) Get() *VirtualCircuitTerminationRequest {
	return v.value
}

func (v *NullableVirtualCircuitTerminationRequest) Set(val *VirtualCircuitTerminationRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualCircuitTerminationRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualCircuitTerminationRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualCircuitTerminationRequest(val *VirtualCircuitTerminationRequest) *NullableVirtualCircuitTerminationRequest {
	return &NullableVirtualCircuitTerminationRequest{value: val, isSet: true}
}

func (v NullableVirtualCircuitTerminationRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualCircuitTerminationRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
