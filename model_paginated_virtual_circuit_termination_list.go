...
API version: 4.2.3-Docker-3.2.0 (4.2)
*/
...
// checks if the PaginatedVirtualCircuitTerminationList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedVirtualCircuitTerminationList{}
...
type _PaginatedVirtualCircuitTerminationList PaginatedVirtualCircuitTerminationList
...
func NewPaginatedVirtualCircuitTerminationList(count int32, results []VirtualCircuitTermination) *PaginatedVirtualCircuitTerminationList {
	this := PaginatedVirtualCircuitTerminationList{}
	this.Count = count
...
func (o *PaginatedVirtualCircuitTerminationList) GetResults() []VirtualCircuitTermination {
	if o == nil {
		var ret []VirtualCircuitTermination
		return ret
	}
...
func (o PaginatedVirtualCircuitTerminationList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedVirtualCircuitTerminationList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedVirtualCircuitTerminationList := _PaginatedVirtualCircuitTerminationList{}

	err = json.Unmarshal(data, &varPaginatedVirtualCircuitTerminationList)

	if err != nil {
		return err
	}

	*o = PaginatedVirtualCircuitTerminationList(varPaginatedVirtualCircuitTerminationList)
...
type NullablePaginatedVirtualCircuitTerminationList struct {
	value *PaginatedVirtualCircuitTerminationList
	isSet bool
}

func (v NullablePaginatedVirtualCircuitTerminationList) Get() *PaginatedVirtualCircuitTerminationList {
	return v.value
}

func (v *NullablePaginatedVirtualCircuitTerminationList) Set(val *PaginatedVirtualCircuitTerminationList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedVirtualCircuitTerminationList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedVirtualCircuitTerminationList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedVirtualCircuitTerminationList(val *PaginatedVirtualCircuitTerminationList) *NullablePaginatedVirtualCircuitTerminationList {
	return &NullablePaginatedVirtualCircuitTerminationList{value: val, isSet: true}
}

func (v NullablePaginatedVirtualCircuitTerminationList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedVirtualCircuitTerminationList) UnmarshalJSON(src []byte) error {
	v.isSet = true
