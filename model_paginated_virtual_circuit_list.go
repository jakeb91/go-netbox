...
// checks if the PaginatedVirtualCircuitList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedVirtualCircuitList{}
...
type _PaginatedVirtualCircuitList PaginatedVirtualCircuitList
...
func NewPaginatedVirtualCircuitList(count int32, results []VirtualCircuit) *PaginatedVirtualCircuitList {
	this := PaginatedVirtualCircuitList{}
	this.Count = count
...
func (o PaginatedVirtualCircuitList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedVirtualCircuitList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedVirtualCircuitList := _PaginatedVirtualCircuitList{}

	err = json.Unmarshal(data, &varPaginatedVirtualCircuitList)

	if err != nil {
		return err
	}

	*o = PaginatedVirtualCircuitList(varPaginatedVirtualCircuitList)
...
type NullablePaginatedVirtualCircuitList struct {
	value *PaginatedVirtualCircuitList
	isSet bool
}

func (v NullablePaginatedVirtualCircuitList) Get() *PaginatedVirtualCircuitList {
	return v.value
}

func (v *NullablePaginatedVirtualCircuitList) Set(val *PaginatedVirtualCircuitList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedVirtualCircuitList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedVirtualCircuitList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedVirtualCircuitList(val *PaginatedVirtualCircuitList) *NullablePaginatedVirtualCircuitList {
	return &NullablePaginatedVirtualCircuitList{value: val, isSet: true}
}

func (v NullablePaginatedVirtualCircuitList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedVirtualCircuitList) UnmarshalJSON(src []byte) error {
	v.isSet = true
