...
// SetDeviceType gets a reference to the given BriefDeviceType and assigns it to the DeviceType field.
...
// SetRole gets a reference to the given BriefDeviceRole and assigns it to the Role field.
...
// SetSite gets a reference to the given BriefSite and assigns it to the Site field.
